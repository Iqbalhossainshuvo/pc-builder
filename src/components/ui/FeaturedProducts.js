          ...
          >
            <Link href={`/products/${product?._id}`}>
              <div className="relative">
                ...
                />
                <div className="absolute top-0 right-0 bg-blue-400 text-white text-xs font-semibold rounded-bl-full py-1 px-3">
                  {product?.Category}
                </div>
              </div>
            ...
            <div className="flex items-center justify-between px-4">
              ...
              <div className="flex items-center">
                <AiFillStar className="text-yellow-400 text-[19px] mr-1.5" />
            ...
            <div className="absolute top-0 left-0 bg-yellow-400 text-white text-xs font-semibold py-1 px-3 rounded-br-full ">
              {product?.Status}
            </div>
          </div>
        ))}
