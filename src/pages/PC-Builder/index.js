...
const PCBuilder = () => {
  ...
  const showChoosedProduct = (category) => {
    ...
    } else if (category === "PowerSupplyUnit") {
        ...
        <div className="flex items-center justify-between">
          ...
          {Object.entries(builderState).every(
            ...
            <button
              ...
              type="button"
              className="py-2 px-4 border border-transparent md:text-[16px] text-[12px] font-medium rounded-md text-white bg-yellow-400 hover:bg-blue-100"
            >
              Complete Build
            </button>
          ) : (
            <button
              disabled
              type="button"
              className="py-2 px-4 border border-transparent md:text-[16px] text-[12px] font-medium rounded-md text-white bg-blue-300"
            >
              Complete Build
            </button>
          )}
